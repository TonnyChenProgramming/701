...
package asp_packet_pkg is
    ...
    -- Node addresses
    --------------------------------------------------------------------
    constant NULL_ADDR          : addr8_t := "00000000";
    constant RECOP_ADDR         : addr8_t := "00000001";
    constant NIOS_II_ADDR       : addr8_t := "00000010";
    constant SIG_GENERATOR_ADDR : addr8_t := "00000011";
    constant AVE_ASP_ADDR       : addr8_t := "00000100";
    constant COR_ASP_ADDR       : addr8_t := "00000101";
    constant PK_ADDR            : addr8_t := "00000110";
