...
entity multicycle_moore_machine_recop is
    port (
        clk      : in  bit_1;
        init     : in  bit_1;
        reset    : in  bit_1;
        ...
        per_input_flag : in bit_1;
        sop_status_flag : in bit_1;

        -- command related output control signals
        dpcr_cmd_lden : out bit_1;
        sop_status_ld : out bit_1;
        -- current_fsm state for debugging
        state_bits : out bit_4;
        -- Register File
        ld_r         : out bit_1;
...
architecture beh of multicycle_moore_machine_recop is

    type state_type is (
        S_EVENT_CHECK,
        S_WRITE_COMMAND,
        S_STATUS_OUPUT_UPDATE,
        S_FETCH,
        S_DECODE,
        S_EXECUTE,
        S_MEM_READ,
...
begin
    ...
    ----------------------------------------------------------------
    process(per_input_flag, state, opcode)
    begin
        next_state <= S_EVENT_CHECK;
