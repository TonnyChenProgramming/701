...
begin
    cmd_ready <= '1';
    in_ready <= enabled and not out_valid_reg;
    out_valid <= out_valid_reg;
    out_word <= make_packet(PKT_KIND_DATA, "0000", dest_node, payload_from_sample16(avg_reg));
    ...
    begin
        if rising_edge(clk) then
            if reset = '1' then
                ...
                if in_valid = '1' and in_ready = '1' and packet_kind(in_word) = PKT_KIND_DATA then
