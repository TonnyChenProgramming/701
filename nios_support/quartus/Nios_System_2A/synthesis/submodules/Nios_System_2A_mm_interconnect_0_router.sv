...
(
    ...
    localparam PAD4 = log2ceil(64'h8011040 - 64'h8011020); 
    localparam PAD5 = log2ceil(64'h8011050 - 64'h8011040); 
    localparam PAD6 = log2ceil(64'h8011060 - 64'h8011050); 
    localparam PAD7 = log2ceil(64'h8011068 - 64'h8011060); 
    localparam PAD8 = log2ceil(64'h8011078 - 64'h8011070); 
    localparam PAD9 = log2ceil(64'h8014000 - 64'h8012000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8014000;
    ...
    // ( 0x8012000 .. 0x8014000 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 28'h8012000   ) begin
